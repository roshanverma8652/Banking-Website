    ...
    if (($amount)<0)
   {
    ...
    // constraint to check zero values
         ...
         echo "</script>";
                ...
                if($query){
                     echo '<script> alert("Congratulation! Transaction Successfull");
...
<head>
    ...
    <title>Transaction | Bank Of Sparks</title>
...
<br><br><br>
	...
	<div class="container">
        ...
        <br>
            ...
            <button class="btn btn-danger mt-3" name="submit" type="submit" id="myBtn">Transfer</button>
            </div>
        </form>
    </div>
