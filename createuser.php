...
<?php
    ...
    if($result){
               echo '<script> alert("Good job! User created");
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="index.html">Bank Of Sparks</a>
...
<br><br><br><br><br>
  ...
  <div class="container">
    <div class="screen">
      ...
      <div class="screen-body" style="background:#e94d4d; color:black;">
        <div class="screen-body-item left">
          <img class="img-fluid" src="https://img.icons8.com/pastel-glyph/200/000000/add-user-male--v2.png" style="border: none; border-radius: 0%; height:200px; width:200px;">
        </div>
