...
<head>
    ...
    <title>Transfer Money | Bank Of Sparks</title>
            ...
            <div class="row">
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn btn-danger">Transfer</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
